<template>
  <div class="grid text-[1.1em] gap-[0.75em] mx-[2vh] my-[40vh]">
    <div class="row-[1] col-[1]">
      <h1 class="text-[1.2em] font-[bold]">
        Hi!
      </h1>
      <p>I'm Eleven, a forensic investigator and software engineer</p>
    </div>

    <div class="row-[2] col-[1]">
      <ul class="flex list-none gap-[.5em]">
        <li>
          <a
            title="/arthureleven"
            href="https://github.com/arthureleven"
          >
            <svg
              fill="currentcolor"
              height="1.5em"
        ...
        <li>
          <a
            title="@arthureleven_"
            href="https://discord.com/users/480449845773991937"
          >
            <svg
              fill="currentcolor"
              height="1.5em"
        ...
        <li>
          <a
            title="/arthureleven"
            href="https://steamcommunity.com/id/arthureleven"
          >
            <svg
              fill="currentcolor"
              height="1.5em"
        ...
        <li>
          <a
            title="/arthureleven"
            href="https://anilist.co/user/arthureleven"
          >
            <svg
              fill="currentcolor"
              height="1.5em"
